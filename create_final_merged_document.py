#!/usr/bin/env python3
"""
Create the final merged document with updated annexures
"""

import PyPDF2
import os

def create_final_merged_document():
    """Create the final merged document with updated annexures"""
...
if __name__ == "__main__":
    print("Creating final merged document with updated annexures...")
    final_doc = create_final_merged_document()
