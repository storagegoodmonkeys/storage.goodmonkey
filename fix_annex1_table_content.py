#!/usr/bin/env python3
"""
Fix the empty table content in Updated Annex 1 PDF
"""
...
def create_annex1_with_populated_table():
    """Create Updated Annex 1 PDF with properly populated table"""
    
    filename = "/Users/tayyab/Desktop/flick/Updated_Annex1_Detailed_Scope_FINAL.pdf"
    ...
    # Enhanced Database Schema - PROPERLY POPULATED
    ...
    # Create a properly populated table with actual content
    db_data = [
    ...
    # Build PDF
    doc.build(story)
    print(f"✅ Final Annex 1 PDF with populated table created: {filename}")
    return filename


if __name__ == "__main__":
    print("Creating Annex 1 with properly populated database table...")
    final_pdf = create_annex1_with_populated_table()
    print(f"\n✅ Final PDF created: {final_pdf}")
    print("📄 The database schema table is now properly populated with all the table details!")
